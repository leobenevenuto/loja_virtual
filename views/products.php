<div class="row">
	...
	<div class="col-sm-7">
		...
		<small>Marca: <?php echo $product_info['brand_name']; ?></small></br>
		...
		<form method="POST" class="addtocartform" action="<?php echo BASE_URL; ?>cart/add">
			...
			<button data-action="decrease">-</button><input type="text" name="qt" value="1" class="addtocart_qt" disabled="disabled" /><button data-action="increase">+</button>
			<input type="submit" class="cart_submit" value="<?php $this->lang->get('ADD_TO_CART'); ?>">
		</form>
...
<div class="row">
	...
	<div class="col-sm-6">
		<h3>Resenhas sobre o produto</h3>
		<?php foreach ($product_rates as $rate): ?>
			<strong><?php echo $rate['user_name']; ?></strong> <small>(Nota: <?php echo $rate['points']; ?>)</small><br/>

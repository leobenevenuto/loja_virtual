				  		...
				  		<div class="filterarea">
				  			...
				  			<form method="GET">
					  				...
					  				<div class="filtercontent">
					  					<div class="filteritem">
					  						...
					  						<label for="filter_star0">
					  							(<?php echo $this->lang->get('NO_STAR'); ?>)
					  						</label>
					  					...
					  					<div class="filteritem">
					  						...
					  						<label for="filter_star1">
					  							<img src="<?php echo BASE_URL ?>assets/images/star.png" height="15" border="" />
					  						</label>
					  			...
					  			<div class="filterbox">
					  				...
					  				<div class="filtercontent">
					  					<div class="filteritem">
					  						<input type="checkbox" name="filter[sale]" value="1" <?php echo (isset($viewData['filters_selected']['sale']) == '1')?'checked="checked"':''; ?> id="filter_sale" /><label for="filter_sale">Em promoção</label>
